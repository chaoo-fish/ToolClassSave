...
/*Set<GatewayFlowRule> rules = new HashSet<>();
        ...
        // 上面的代码是基于 route维度进行限流
        // 下面的代码是基于自定义API维度进行限流

        Set<GatewayFlowRule> rules = new HashSet<>();
        rules.add(new GatewayFlowRule("product_api1")
                .setCount(1)
                .setIntervalSec(1));

        rules.add(new GatewayFlowRule("product_api2")
                .setCount(1)
                .setIntervalSec(1));
        GatewayRuleManager.loadRules(rules);
    }
    ...
    private void initCustomizedApis() {
        ...
        ApiDefinition api1 = new ApiDefinition("product_api1")
                .setPredicateItems(new HashSet<ApiPredicateItem>() {{
                    ...
                    add(new ApiPathPredicateItem()
                            .setPattern("/product-api/product/api1/**")
                            .setMatchStrategy(
        ...
        ApiDefinition api2 = new ApiDefinition("product_api2")
                .setPredicateItems(new HashSet<ApiPredicateItem>() {{
                    ...
                    add(new ApiPathPredicateItem()
                            .setPattern("/product-api/product/api2/demo1"));
                }});
